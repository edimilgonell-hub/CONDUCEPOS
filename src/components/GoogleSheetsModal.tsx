...
export const GoogleSheetsModal: React.FC<GoogleSheetsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'directDrive' | 'appsScript' | 'code' | 'export'>(
    currentUser ? 'directDrive' : 'directDrive'
  );
      ...
      <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div className="flex border-b border-slate-200 bg-slate-50 px-6 gap-3 text-xs font-semibold overflow-x-auto">
          ...
          >
            ...
            <span>Forma 1: Google Drive Directo</span>
          ...
          >
            ...
            <span>Forma 2: Apps Script (Multi-PC)</span>
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-4">
          ...
          {activeTab === 'directDrive' && (
            <div className="space-y-4">
              <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-xl text-xs text-emerald-950 space-y-1.5">
                <div className="font-bold flex items-center gap-2 text-sm text-emerald-900">
                  <CloudCheck className="w-5 h-5 text-emerald-600" />
                  Conexión 100% Automática con tu Cuenta de Google
                </div>
                <p className="text-slate-600 leading-relaxed">
                  Inicia sesión con tu correo de Google. El sistema creará automáticamente la hoja de cálculo <strong>"MARTINEZ BATISTA - Control de Conduces y Ventas"</strong> en tu Google Drive y registrará cada venta sin que tengas que copiar código.
                </p>
              </div>
              ...
              {!currentUser ? (
                <div className="py-6 flex flex-col items-center justify-center space-y-3 bg-slate-50 rounded-2xl border border-slate-200">
                  <p className="text-xs font-semibold text-slate-700 text-center">
                    Haz clic en el botón oficial para autorizar el acceso a Google Sheets y Google Drive:
                  </p>
