...
export const INITIAL_CLIENTS: Client[] = [
  {
    id: 'cli-atraguayu',
    name: 'ATRAGUAYU',
    documentId: '07/08/2026',
    phone: '',
    initialBalance: 25000,
    notes: 'Cliente de cotización Martinez Batista Comercial SRL'
  },
  {
    id: 'cli-1',
    name: 'Juan Alberto Rosario Pérez',
    documentId: '001-1458923-4',
    phone: '809-555-0142',
    initialBalance: 25000,
